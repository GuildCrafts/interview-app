          ...
          <div className="uk-flex uk-grid">
            <div className="uk-flex-first">
              <button className="uk-button uk-button-primary"
                      onClick={this.incrementQuestionState.bind(this, 'answered')}>Approve</button>
            </div>
            <div className="uk-flex">
              <button className="uk-button uk-button-danger"
                      onClick={this.incrementQuestionState.bind(this, 'skipped')}>Delete</button>
            </div>
            <div className="uk-flex">
              <button className="uk-button-secondary uk-button" onClick={this.toggleProperty.bind(this, 'showAnswer')}>Edit</button>
            </div>
          </div>
